...
class GenreType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('label', 'text', array('label' => "Genre de serie"))
            // Ajout du champ 'listeDesSeries' permettant de choisir directement les series associés à ce genre
            // Si on ne spécifie pas d'argument, Symfony va générer automatiquement le type de champ adéquat (ici un select box multiple permettant de choisir un ou plusieurs series)
            // Cette syntaxe équivaut à la suivante :
            //     ->add('listeDesSeries', 'entity', array( 
            //       'class' => 'IabsisVideothequeBundle:Serie',
            //       'multiple' => true,
            //       'label' => "Liste des series"
            //    )); 
            //  
            ->add('listeDesSeries');
    }
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Acme\FishBlockBundle\Entity\Genre'
        ));
    }
