...
use Acme\FishBlockBundle\Form\GenreType;
...
class GenreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $genres = $em->getRepository('AcmeFishBlockBundle:Genre')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeFishBlockBundle:Genre')->find($id);
     ...
     * @Method("PUT")
     * @Template("AcmeFishBlockBundle:Genre:edit.html.twig")
     */
